...
// Static resources
std::unique_ptr<ppgso::Mesh> Eyes::mesh;
std::unique_ptr<ppgso::Texture> Eyes::texture;
std::unique_ptr<ppgso::Shader> Eyes::shader;
...
Eyes::Eyes() {
    ...
    if (!mesh) mesh = std::make_unique<ppgso::Mesh>("eyes.obj");
}
