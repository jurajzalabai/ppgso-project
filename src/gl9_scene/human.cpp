...
void Human::explode(Scene &scene, glm::vec3 explosionPosition, glm::vec3 explosionScale, int pieces) {
    // Generate explosion
    ...
    for (int i = 0; i < pieces; i++) {
        auto asteroid = std::make_unique<Human>();
...
void Human::onClick(Scene &scene) {
